...
return new class extends Migration
{
    ...
    {
        Schema::create('hubpsot_contact_profile_2nd_copy', function (Blueprint $table) {
            $table->id('contact_id');
            ...
            $table->string('hubspot_created_at')->nullable(); //createdate
            $table->string('hubspot_updated_at')->nullable(); //lastmodifieddate
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('hubspot_contact_profile_2nd_copy');
    }
};
