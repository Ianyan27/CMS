...
class CompanyService
{
     ...
     */
    public function searchCompanies($startDate, $endDate, $limit = 100, $after = null)
    {
     ...
     */
    public function countCompanies($startDate, $endDate)
    {
        $result = $this->searchCompanies($startDate, $endDate, 1);
    ...
    public function findOptimalTimeWindow($startDate, $endDate)
    {
        ...
        $totalContacts = $this->countCompanies($startDate, $optimalEndDate);
     ...
     */
    public function getAllCompaniesInTimeWindow($startDate, $endDate)
    {
        $contacts = [];
        $after = null;
        $hasMore = true;
        ...
        while ($hasMore && $pageCount < $maxPages) {
            try {
                ...
                $response = $this->searchCompanies($startDate, $endDate, $batchSize, $after);
    ...
    public function searchCompaniesByModifiedDate($startDate, $endDate, $limit = 100, $after = null)
    {
        $url = "{$this->baseUrl}/crm/v3/objects/companies/search";
     ...
     */
    public function countCompaniesByModifiedDate($startDate, $endDate)
    {
        $result = $this->searchCompaniesByModifiedDate($startDate, $endDate, 1);
        return $result['total'] ?? 0;
    }
    ...
    public function findOptimalTimeWindowByModifiedDate($startDate, $endDate)
    {
        ...
        $totalContacts = $this->searchCompaniesByModifiedDate($startDate, $optimalEndDate);
     ...
     */
    public function getAllCompaniesByModifiedDate($startDate, $endDate)
    {
        $contacts = [];
        $after = null;
        $hasMore = true;
        ...
        while ($hasMore && $pageCount < $maxPages && count($contacts) < $maxContactsToRetrieve) {
            try {
                ...
                $response = $this->searchCompaniesByModifiedDate($startDate, $endDate, $batchSize, $after);
