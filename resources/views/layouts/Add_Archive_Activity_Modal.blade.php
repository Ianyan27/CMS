<!-- Add Activity Modal -->
<div class="modal fade" id="addArchiveActivityModal" tabindex="-1" aria-labelledby="addArchiveActivityModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content rounded-0">
            <div class="modal-header d-flex justify-content-between align-items-center"
                ...
                <h5 class="modal-title font-educ" id="editContactModalLabel">
            ...
            <div class="modal-body">
                <form action=" {{ route('archive#save-activity', $editArchive->contact_archive_pid) }} " method="POST"
                    id="addArchiveActivityForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="contact_pid" value=" {{ $editArchive->contact_pid }} " readonly>
