            ...
            <div class="row mx-1 mb-1">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="email" class="form-control fonts" id="email"
                            value=" {{ $editOwner->owner_email_id }} " readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fonts" id="job-role"
                            value=" {{ $editOwner->owner_business_unit }} " readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex justify-content-center btn-group mb-3" role="group"
                        ...
                        <button type="button" class="btn activity-button mx-2"
