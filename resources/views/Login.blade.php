    ...
    <div class="container-fluid d-flex flex-column" style="min-height: 100vh; padding: 0; overflow-x: hidden;">
        ...
        <div class="container-fluid d-flex justify-content-center align-items-center flex-grow-1" style="padding: 0;">
            <div class="text-center p-5 border-educ" style="background-color: white; border-radius: 10px;">
                ...
                <a href="#" class="btn d-flex align-items-center justify-content-center" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header"
                    style="height: 90px;
     background: hsla(339, 100%, 73%, 1);
     background: linear-gradient(180deg, rgb(255, 180, 206) 0%, hsla(0, 0%, 100%, 1) 100%);border:none;">
                    <h5 class="modal-title" id="loginModalLabel" style="color: #91264c"><strong>Microsoft Login</strong>
                    </h5>
